...
(function () {
  ...
  LNOE.scenarioEndings = {
    "Defend the Manor House": "The survivors stepped outside the Manor House as the morning sun rose over the town. The streets were quiet, and for the first time in many hours, there were no sounds of zombies. More survivors soon arrived and helped repair the broken doors and windows. In the days that followed, the Manor House became a safe place where people could gather, share supplies, and rebuild their lives. The battle had been won, but the memory of that terrible night would never be forgotten. They had survived the Last Night on Earth.",
    "Escape in the Truck": "The truck carried the heroes far away from the town before finally coming to a stop. The next morning, they found shelter and began searching for food and fuel. Over the following days, they met other survivors and formed a small group determined to stay alive. Though they had lost their homes, they had not lost hope. A new journey was about to begin. They had lived through the Last Night on Earth.",
    "Rescue Mission": "As the sun rose, the rescued survivors gathered together in safety. Families reunited and shared stories of how they escaped the zombie horde. In the weeks that followed, they worked together to rebuild their community and care for those who had lost everything. The heroes became a symbol of courage and hope for everyone who survived. Together, they had survived the Last Night on Earth.",
    "Die, Zombies, Die!": "The next day, the heroes searched every street and building to make sure the town was safe. Finding no sign of the undead, the survivors slowly emerged from hiding. Shops reopened, neighbours helped one another, and life began to return to normal. It would take time to recover, but humanity had won an important victory. They had defeated the Last Night on Earth.",
    "Burn 'Em Out!": "The fire continued to burn long after sunrise, destroying the last traces of the zombie threat. In the days that followed, the survivors cleared the ruins and made plans to rebuild. Though much had been lost, they knew the danger was finally over. The town had been given a second chance, and they would not waste it. They had survived the Last Night on Earth.",
    "Save the Townsfolk": "The townsfolk woke the next morning surrounded by friends, family, and the heroes who had saved them. Fear slowly faded and was replaced by relief and gratitude. Over the coming weeks, the people worked together to rebuild their homes and restore their town. The heroes never asked for thanks, but everyone knew who had protected them when it mattered most. Because of the heroes, the townsfolk had survived the Last Night on Earth."
  };
